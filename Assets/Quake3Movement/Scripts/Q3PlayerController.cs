...
namespace Q3Movement
{
    ...
    public class Q3PlayerController : MonoBehaviour
    {
        ...
        public float v_mass = 3.0f;
        public float forceTeste = 10;
        private Vector3 v_impact = Vector3.zero;
        ...
        private void Update()
        {
            ...
            {
                AddForce(transform.forward, forceTeste);
            }
        ...
        public void AddForce(Vector3 dir, float force)
        {
            ...
            v_impact += dir.normalized * force / v_mass;
        }
